...
**Twipath** is an android app that allows a user to view their Twitter timeline and post a new tweet. The app utilizes [Twitter REST API](https://dev.twitter.com/rest/public). (Best of all, no ads!!)
...
<img src='twipath2.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />
